<template>
  <div class="uk-container" style="margin-bottom: 3rem;" v-if="donHang">
    ...
    <div uk-alert class="uk-alert-danger" v-if="errors.any()">
    ...
    <div uk-alert style="margin-top: 2rem;" v-if="errors.any()">
    ...
    <div class="uk-text-right uk-inline" style="width: 100%;">
      ...
      <button class="uk-button uk-button-default uk-button-primary" :disabled="errors.any()" @click="createNewDonHang">Gửi đơn hàng</button>
    </div>
  </div>
</template>
  ...
  watch: {
    'thongTinDonHang': {
      handler: _.debounce(function (value) {
        if (!this.thongTinDonHang.isThongTinGiaoHangKhacThongTinThanhToan) {
